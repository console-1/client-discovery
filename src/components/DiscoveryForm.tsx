        ...
        return (
          <div className="space-y-5">
            ...
            <div className="flex justify-between mt-8">
              <button
                onClick={prevSection}
                className="flex items-center gap-2 px-5 py-2 border border-stone-200 rounded-full text-stone-600 hover:bg-stone-100 transition-all"
              >
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                value={formData.pastPartnerships}
                onChange={handleInputChange}
                className="textarea-mint"
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                value={formData.idealCollaboration}
                onChange={handleInputChange}
                className="textarea-mint"
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                value={formData.valueExpectations}
                onChange={handleInputChange}
                className="textarea-mint"
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                value={formData.feedbackOnIdeas}
                onChange={handleInputChange}
                className="textarea-mint"
    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      {SECTIONS.map((section, index) => (
        <div
          key={section.id}
          className={cn(
            "transition-all duration-500 ease-out absolute w-[calc(100%-2rem)] max-w-3xl",
            currentSection === index ? "opacity-100 z-10 translate-x-0" : "opacity-0 -z-10 translate-x-8"
          )}
          style={{ display: Math.abs(currentSection - index) <= 1 ? 'block' : 'none' }}
        >
          <FormSection
            title={section.title}
